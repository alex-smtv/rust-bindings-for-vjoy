...
#pragma warning( disable : 4995 )
	...
	VJOYINTERFACE_API VjdStat	__cdecl	GetVJDStatus(UINT rID);			// Get the status of the specified vJoy Device.
	// Added in 2.1.6
	...
	VJOYINTERFACE_API BOOL		__cdecl	UpdateVJD(UINT rID, JOYSTICK_POSITION_V2* pData);	// Update the position data of the specified vJoy Device.
